...
Victor.prototype.interpolate = function (a, unit) {
    ...
    var ix = (unit / d) * (a.x - self.x);
    var iy = (unit / d) * (a.y - self.y);
...
var Canvas = /** @class */ (function () {
     ...
     */
    function Canvas(elem, renderIndefinite) {
        if (renderIndefinite === void 0) { renderIndefinite = false; }
        this._pause = false;
        this.baseUnit = 5;
        this.objects = [];
     ...
     */
    Canvas.prototype.removeObject = function (obj) {
     ...
     * @param obj
     */
    Canvas.prototype.isInViewPort = function (obj) {
    ...
    Canvas.prototype.render = function () {
        ...
        this.objects.map(function (shape) {
            shape.render(_this.context, _this.baseUnit);
        });
        if (this.renderIndefinite && !this._pause) {
            requestAnimationFrame(this.render);
        }
    };
    Object.defineProperty(Canvas.prototype, "isPaused", {
        get: function () {
            return this._pause;
        },
        enumerable: true,
...
var Circle = /** @class */ (function (_super) {
     ...
     * @param color
     */
    function Circle(radius, color, shadowBlur) {
        ...
        // Set default position.
        _this.setPosition(radius, radius);
        return _this;
    }
    /**
     * Renders the object on canvas context.
     ...
     */
    Circle.prototype.getDimensions = function () {
        return {
            x: this.curPosition.x,
            y: this.curPosition.y,
            width: this.radius * 2,
...
var Point_1 = __webpack_require__(1);
var Shapes_1 = __webpack_require__(0);
// Set globals here.
var w = window;
w.Canvas = index_1.Canvas;
